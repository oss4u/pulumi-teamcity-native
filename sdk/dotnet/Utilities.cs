...
namespace Pulumi.Teamcity
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/oss4u/pulumi-teamcity-native";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Teamcity.version.txt");
    ...
    internal sealed class TeamcityResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public TeamcityResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
